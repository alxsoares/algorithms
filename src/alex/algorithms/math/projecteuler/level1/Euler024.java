...
public class Euler024 {
	...
	public static void main(String[] args) {
		...
		// 9!
		int[] facDigits = new int[10];
		for (int i = 10 - 1, n = 999999; i >= 0; i--) {
			int remain = n % base[10 - 1 - i];
			facDigits[10 - 1 - i] = (n - remain) / base[10 - 1 - i];
			n = remain;
		}
		System.out.println("F(999999): " + Arrays.toString(facDigits));
		...
		for (int i = 0; i < 10; i++) {
			permutation.append(numbers.remove(facDigits[i]));
		}
