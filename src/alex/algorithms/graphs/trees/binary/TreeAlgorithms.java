...
public class TreeAlgorithms {
	...
	public static Node<Integer> insertNodeBST(final Node<Integer> root,
			final int value) {
		if (root == null) {
	...
	public static void lowestCommonAntecessor(Node<Integer> root, final int i,
			final int j) {
	...
	public static Node<Integer> leastCommonAntecessor(final Node<Integer> root,
			final int n1, final int n2) {
		if (root == null || root.getValue() == n1 || root.getValue() == n2)
			return null;
		if (root.getRight() != null
				&& (root.getRight().getValue() == n1 || root.getRight()
						.getValue() == n2)) {
			return root;
		}
		if (root.getLeft() != null
				&& (root.getLeft().getValue() == n1 || root.getLeft()
						.getValue() == n2)) {
			return root;
		}
	...
	public static void printVerticalSumOfTree(final Node<Integer> tree,
			final int axisVal, final int[] sums) {
		if (tree == null)
			return;
	...
	public static void printHorizontalSumOfTree(final Node<Integer> tree,
			final int axisVal, final int[] sums) {
		if (tree == null)
			return;
		sums[axisVal] += tree.getValue();
	...
	private static void findPath(final Node<Integer> root,
			final int expectedSum, int currentSum, final ArrayList<Integer> path) {
	...
	public static void printPaths(final Node<Integer> root,
	...
	private static boolean isSymmetrical(final Node<Integer> root,
			final Node<Integer> root2) {
